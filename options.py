...
def get_options(args=None):
    ...
    # Data
    parser.add_argument('--problem', default='local', help="The problem to solve, default 'tsp'")
    ...
    parser.add_argument('--policy_mode', default='reviser', help="policy mode for collaborative policies training, 'seeder or 'reviser'")
